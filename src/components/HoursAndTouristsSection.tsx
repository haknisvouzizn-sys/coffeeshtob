...
export const HoursAndTouristsSection: React.FC<HoursAndTouristsSectionProps> = ({ content }) => {
  return (
    <section id="hours" className="py-16 sm:py-24 px-5 sm:px-8 lg:px-12 bg-[#FAF7F2] border-t border-[#EAE0D5]">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 sm:gap-8 items-stretch mb-8">
          ...
          <div className="lg:col-span-6 rounded-3xl p-6 sm:p-10 bg-[#F2EAE0] border border-[#E5D7C9] flex flex-col justify-between shadow-sm transition-all duration-500 ease-out hover:-translate-y-1.5 hover:shadow-xl hover:border-[#D4BFA9] group">
            <div>
              <div className="w-12 h-12 rounded-2xl bg-[#E5D7C9] group-hover:bg-[#BC6C3F] text-[#BC6C3F] group-hover:text-white flex items-center justify-center mb-6 transition-colors duration-400">
                <Clock className="w-6 h-6 transition-transform duration-300 group-hover:scale-110" />
              </div>

              <h3 className="font-serif text-2xl sm:text-4xl font-bold tracking-tight text-[#2C180F] mb-6 group-hover:text-[#BC6C3F] transition-colors duration-300">
          ...
          <div id="tourists" className="lg:col-span-6 rounded-3xl p-6 sm:p-10 bg-[#F2EAE0] border border-[#E5D7C9] text-[#2C180F] shadow-sm flex flex-col justify-between transition-all duration-500 ease-out hover:-translate-y-1.5 hover:shadow-xl hover:border-[#D4BFA9] group">
            <div>
              <div className="w-12 h-12 rounded-2xl bg-[#E5D7C9] group-hover:bg-[#BC6C3F] text-[#BC6C3F] group-hover:text-white flex items-center justify-center mb-6 transition-colors duration-400">
                <Map className="w-6 h-6 transition-transform duration-300 group-hover:scale-110" />
              </div>

              <h3 className="font-serif text-2xl sm:text-4xl font-bold tracking-tight text-[#2C180F] mb-4 group-hover:text-[#BC6C3F] transition-colors duration-300">
        ...
        <div className="rounded-3xl p-6 sm:p-8 bg-[#F2EAE0] border border-[#E5D7C9] flex flex-col md:flex-row items-start md:items-center justify-between gap-6 shadow-sm transition-all duration-500 ease-out hover:shadow-md hover:border-[#D4BFA9] group">
          <div className="flex items-start gap-4">
            <div className="w-11 h-11 rounded-2xl bg-[#E5D7C9] group-hover:bg-[#BC6C3F] text-[#BC6C3F] group-hover:text-white flex items-center justify-center shrink-0 mt-0.5 transition-colors duration-300">
              <Ship className="w-5 h-5 transition-transform duration-300 group-hover:scale-110" />
            </div>
            <div>
              <h4 className="font-bold text-base sm:text-lg text-[#2C180F] mb-1 group-hover:text-[#BC6C3F] transition-colors duration-300">
